...
@Component({
  selector: 'app-super-region',
  templateUrl: './super-region.component.html',
  styleUrls: ['./super-region.component.css']
})
export class SuperRegionComponent implements OnInit {
